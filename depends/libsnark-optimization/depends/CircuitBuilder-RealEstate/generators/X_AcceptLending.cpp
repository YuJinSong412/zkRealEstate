...
//             nextInputWires = {cout->get(1), cin->get(1), index}; //concat
//             hashGadget = allocate<HashGadget>(this, nextInputWires);
...
//             addEqualityAssertion(bond_balance, dv_, "invalid bond_balance");


//             // //CT_table = H(table_balance)
//             hashGadget = allocate<HashGadget>(this, table_balance);
//             addEqualityAssertion(hashGadget->getOutputWires()[0], CT_table, "CT_table not equal");


//             // k_msg = PKE.Dec(usk,CT_k_creditor)-> enc로 

...
namespace Gadgets {
    ...
    class ECGroupGeneratorGadget : public Gadget {
    ...
    private:
        ...
        // WirePtr outputPublicValue; 
        Wires outputPublicValue; 

        vector<AffinePoint> baseTable;
        ...
        vector<AffinePoint> preprocess(AffinePoint p);


        /**
         * Performs scalar multiplication (secretBits must comply with the conditions above)
         */
        AffinePoint mul(AffinePoint p, Wires & secretBits, vector<AffinePoint> & precomputedTable) ;

        AffinePoint doubleAffinePoint(AffinePoint p) ;
        AffinePoint addAffinePoints(AffinePoint p1, AffinePoint p2) ;
        AffinePoint subAffinePoints(AffinePoint p1, AffinePoint p2) ;
    ...
    public:
        ...
        ECGroupGeneratorGadget(CircuitGenerator* generator, WirePtr baseX, WirePtr secret, string desc="") ;
        ECGroupGeneratorGadget(CircuitGenerator* generator, WirePtr baseX, WirePtr baseY , WirePtr secret, string desc="") ;

...
{
    //profile.enter_block("Call to alt_bn128_final_exponentiation_first_chunk");
    ...
    */
    ...
    //profile.leave_block("Call to alt_bn128_final_exponentiation_first_chunk");
...
{
    //profile.enter_block("Call to alt_bn128_exp_by_neg_z");
    ...
    //profile.leave_block("Call to alt_bn128_exp_by_neg_z");
...
{
    //profile.enter_block("Call to alt_bn128_final_exponentiation_last_chunk");
    ...
    */
    ...
    //profile.leave_block("Call to alt_bn128_final_exponentiation_last_chunk");
...
{
    //profile.enter_block("Call to alt_bn128_final_exponentiation");
    /* OLD naive version:
    ...
    */
    ...
    //profile.leave_block("Call to alt_bn128_final_exponentiation");
    return result;
}
...
{
    //profile.enter_block("Call to alt_bn128_ate_precompute_G1");
    ...
    //profile.leave_block("Call to alt_bn128_ate_precompute_G1");
    return result;
}

alt_bn128_ate_G2_precomp alt_bn128_ate_precompute_G2(const alt_bn128_G2& Q )
{
    //profile.enter_block("Call to alt_bn128_ate_precompute_G2");
    ...
    //profile.leave_block("Call to alt_bn128_ate_precompute_G2");
    return result;
}
...
{
    //profile.enter_block("Call to alt_bn128_ate_miller_loop");
    ...
    //profile.leave_block("Call to alt_bn128_ate_miller_loop");
    return f;
}
...
{
    //profile.enter_block("Call to alt_bn128_ate_double_miller_loop");
    ...
    //profile.leave_block("Call to alt_bn128_ate_double_miller_loop");
...
{
    //profile.enter_block("Call to alt_bn128_ate_pairing");

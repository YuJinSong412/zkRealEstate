...
template<mp_size_t n>
std::string bigint<n>::get_hex_string () const
{
    char hex_str [4096];
    gmp_snprintf( hex_str, 4096 , "%Nx", this->data, n);
    return std::string(hex_str);
}


template<mp_size_t n>
void bigint<n>::assign( const char *  set_string , int notation )   
{   
    mpz_t k ;
    mpz_init2(k, 256 );
    mpz_set_str(k  , set_string , notation );

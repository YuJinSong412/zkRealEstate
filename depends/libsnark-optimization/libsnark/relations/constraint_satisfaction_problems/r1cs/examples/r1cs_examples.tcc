...
{
    profile.enter_block("Call to generate_r1cs_example_with_field_input");
    ...
    profile.leave_block("Call to generate_r1cs_example_with_field_input");
...
r1cs_example<FieldT> generate_r1cs_example_with_binary_input(const size_t num_constraints,
                                                             ...
                                                             libff::profiling & profile)
{
    profile.enter_block("Call to generate_r1cs_example_with_binary_input");
    ...
    profile.leave_block("Call to generate_r1cs_example_with_binary_input");

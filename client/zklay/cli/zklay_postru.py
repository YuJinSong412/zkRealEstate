...
from zklay.cli.constants import ETH_ADDRESS_DEFAULT, ROLLUP_URL_DEFAULT, POST_HEADERS_JSON
...
def postru(
    ...
    r = requests.post(ROLLUP_URL_DEFAULT, trans_param.to_json(), headers=POST_HEADERS_JSON)
